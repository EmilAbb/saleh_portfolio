...
{{--                </div>--}}
                ...
                <div class="form-group">
                    <label>Menu</label>
                    <input type="text" placeholder="Menu" name="menu" value="{{old('menu',$model->menu ?? '')}}" class="form-control">
                    @error('menu')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label>Href</label>
                    <input type="text" placeholder="Href" name="href" value="{{old('href',$model->href ?? '')}}" class="form-control">
                    @error('href')
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
